...
$query = "UPDATE `driver` SET active =0b1 ,accadmin='$adminname' WHERE email = '$driveremail'";
$result = mysqli_query($con,$query);
//**************************************
$to_email = $driveremail;
$subject = "طلب سائق جديد";
$body =" مرحباً بك ,نحن سعداء بقبولك كسائق لدى أوتوباس. نرجو منك الأخذ بقواعد السلامة العامة على الطرق و توخي الحذر, بالإضافة إلى الاهتمام بتأمين السيارة و تحيث موعد انتهاءه كل فترة وذلك لضمان حقك في الاستمرار باستخدام التطبيق. مع أطيب الأمنيات $drivername";
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <h5 style="color: limegreen ;text-align: center">
                            ...
                            echo " ***** Driver <b style='color: black'>$drivername</b> Accepted successfuly ***** ";
                            } else {
